...
<div class="side-bar flex-shrink-0 p-3">
  <a href="index_main.php" class="d-flex align-items-center justify-content-center pb-3 mb-3 link-dark text-decoration-none border-bottom">
  ...
  <ul class="list-unstyled ps-0">
    ...
    <li class="mb-1 d-flex flex-column">
      ...
      <div class="collapse mt-2 mx-auto" id="Category-collapse">
        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
          <li class="mb-2 sub-li"><a href="30.index_main-category.php" class="text-decoration-none rounded sub-li">Main categories</a></li>
          <li class="sub-li"><a href="30.index_sub-category.php" class="text-decoration-none rounded sub-li">Sub categories</a></li>
        </ul>
      </div>
    </li>
    <hr>
    <li class="mb-1 d-flex flex-column">
      ...
      <div class="collapse mt-2 mx-auto" id="Order-collapse">
        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
          <li class="mb-2 sub-li"><a href="40.index_order-normal.php" class=" text-decoration-none rounded ">Normal orders</a></li>
          <li class="mb-2 sub-li"><a href="40.index_order-barter.php" class=" text-decoration-none rounded ">Barter orders</a></li>
          <li class="sub-li"><a href="40.index_order-bargain.php" class="text-decoration-none rounded ">Bargain orders</a></li>
        </ul>
      </div>
    </li>
    <hr>
    <li class="mb-1 d-flex justify-content-center">
      <a href="50.index_coupon.php">
    ...
    <li class="mb-1 d-flex flex-column">
      ...
      <div class="collapse mt-2 mx-auto" id="Evaluation-collapse">
        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
          <li class="mb-2 sub-li"><a href="60.index_evaluation-normal.php" class="text-decoration-none rounded sub-li ">Form normal orders</a></li>
          <li class="mb-2 sub-li"><a href="60.index_evaluation-barter.php" class="text-decoration-none rounded sub-li">From barter orders</a></li>
          <li class=" sub-li"><a href="60.index_evaluation-bargain.php" class=" text-decoration-none rounded sub-li">From bargain orders</a></li>
        </ul>
      </div>
    </li>
  </ul>
